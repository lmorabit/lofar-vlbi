...
def main( h5parm, msin, helperscriptspath_h5merge='', ):
    ...
    os.system( '/opt/lofar/pyenv-py2/bin/python h5_merger.py --ms {:s} --h5_tables {:s} --h5_out {:s} --circ2lin --add_cs --h5_time-freq {:s} > convertsols.log'.format( msin, h5parm, h5parm_out, h5parm ) )
